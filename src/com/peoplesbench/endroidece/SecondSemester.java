...
public class SecondSemester extends Activity {
	...
	public void onSubClick(View View){
		...
		for(Integer key : nmap.keySet()){
			 ...
			 SharedPreferences settingsfile = PreferenceManager.getDefaultSharedPreferences(this);
				...
				editor.putString("secondsum", String.valueOf(sum));
				editor.putString("secondmul", String.valueOf(mul));
				
				editor.putString("secs1", a1);
				editor.putString("secs2", a2);
				editor.putString("secs3", a3);
				editor.putString("secs4", a4);
				editor.putString("secs5", a5);
				editor.putString("secs6", a6);
				editor.putString("secs7", a7);
				editor.putString("secs8", a8);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_second_semester);
		 ...
		 Spinner et1 = (Spinner)findViewById(R.id.spinner1);
	        ...
	        String fs1 = settingsfile.getString("secs1","0");
	        String fs2 = settingsfile.getString("secs2","0");
	        String fs3 = settingsfile.getString("secs3","0");
	        String fs4 = settingsfile.getString("secs4","0");
	        String fs5 = settingsfile.getString("secs5","0");
	        String fs6 = settingsfile.getString("secs6","0");
	        String fs7 = settingsfile.getString("secs7","0");
	        String fs8 = settingsfile.getString("secs8","0");
...
public int Check(String a){
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.second_semester, menu);
		return true;
	}
