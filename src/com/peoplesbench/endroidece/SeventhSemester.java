...
public class SeventhSemester extends Activity {
	...
	public void onSubClick(View View){
		...
		for(Integer key : nmap.keySet()){
			 ...
			 SharedPreferences settingsfile = PreferenceManager.getDefaultSharedPreferences(this);
				...
				editor.putString("seventhsum", String.valueOf(sum));
				editor.putString("seventhmul", String.valueOf(mul));
				
				editor.putString("sevs1", a1);
				editor.putString("sevs2", a2);
				editor.putString("sevs3", a3);
				editor.putString("sevs4", a4);
				editor.putString("sevs5", a5);
				editor.putString("sevs6", a6);
				editor.putString("sevs7", a7);
				editor.putString("sevs8", a8);
...
private TextView button;
	...
	public void onelclick(View View){
		...
		final String[] items = {"SATELLITE COMMUNICATION","ELECTRONIC TESTING","SOFT COMPUTING","DIGITAL IMAGE PROCESSING"};
...
public void twolclick(View View){
		...
		final String[] items = {"SPEECH PROCESSING","WEB TECHNOLOGY","ADVANCED COMPUTER ARCHITECTURE","ELECTRONICS PACKING","ELECTROMAGNETIC INTERFERNCE"};
...
public void thrlclick(View View){
	
	button = (TextView)findViewById(R.id.textView13);
	
	final String[] items = {"CMOS ANALOG IC DESIGN","ADVANCED MPMC","COGNITIVE RADIO","RADAR NAVIGATION AND AIDS","OPTO ELECTRONIC DEVICES"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_seventh_semester);
		 ...
		 Spinner et1 = (Spinner)findViewById(R.id.spinner1);
	        ...
	        String fs1 = settingsfile.getString("sevs1","0");
	        String fs2 = settingsfile.getString("sevs2","0");
	        String fs3 = settingsfile.getString("sevs3","0");
	        String fs4 = settingsfile.getString("sevs4","0");
	        String fs5 = settingsfile.getString("sevs5","0");
	        String fs6 = settingsfile.getString("sevs6","0");
	        String fs7 = settingsfile.getString("sevs7","0");
	        String fs8 = settingsfile.getString("sevs8","0");
...
public int Check(String a){
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.seventh_semester, menu);
		return true;
	}
