...
public class FourthSemester extends Activity {
	...
	public void onSubClick(View View){
		...
		for(Integer key : nmap.keySet()){
			 ...
			 SharedPreferences settingsfile = PreferenceManager.getDefaultSharedPreferences(this);
				...
				editor.putString("fourthsum", String.valueOf(sum));
				editor.putString("fourthmul", String.valueOf(mul));
				
				editor.putString("frs1", a1);
				editor.putString("frs2", a2);
				editor.putString("frs3", a3);
				editor.putString("frs4", a4);
				editor.putString("frs5", a5);
				editor.putString("frs6", a6);
				editor.putString("frs7", a7);
				editor.putString("frs8", a8);
				editor.putString("frs9", a9);
		...
		setContentView(R.layout.activity_fourth_semester);
		 ...
		 Spinner et1 = (Spinner)findViewById(R.id.spinner1);
	    	...
	    	Spinner et9 = (Spinner)findViewById(R.id.spinner9);	
	         ...
	         String fs1 = settingsfile.getString("frs1","0");
	         String fs2 = settingsfile.getString("frs2","0");
	         String fs3 = settingsfile.getString("frs3","0");
	         String fs4 = settingsfile.getString("frs4","0");
	         String fs5 = settingsfile.getString("frs5","0");
	         String fs6 = settingsfile.getString("frs6","0");
	         String fs7 = settingsfile.getString("frs7","0");
	         String fs8 = settingsfile.getString("frs8","0");
	         String fs9 = settingsfile.getString("frs9","0");
...
public int Check(String a){
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.fourth_semester, menu);
		return true;
	}
