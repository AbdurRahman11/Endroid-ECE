...
public class SixthSemester extends Activity {
	...
	Spinner et9 = (Spinner)findViewById(R.id.spinner9);
	...
	String a9 = et9.getSelectedItem().toString();
	...
	//Multiplying Grade Points
			...
			int d[] = {c1,c2,c3,c4,c5,c6,c7,c8,c9};
			...
			for(Integer key : nmap.keySet()){
				 ...
				 SharedPreferences settingsfile = PreferenceManager.getDefaultSharedPreferences(this);
					...
					editor.putString("sixthsum", String.valueOf(sum));
					editor.putString("sixthmul", String.valueOf(mul));
					
					editor.putString("sixs1", a1);
					editor.putString("sixs2", a2);
					editor.putString("sixs3", a3);
					editor.putString("sixs4", a4);
					editor.putString("sixs5", a5);
					editor.putString("sixs6", a6);
					editor.putString("sixs7", a7);
					editor.putString("sixs8", a8);
					editor.putString("sixs9", a9);
	...
	public void onelclick(View View){
		...
		final String[] items = {"MEDICAL ELECTRONICS","ADVANCED DSP","OPERATING SYSTEMS","ROBOTICS AND AUTOMATION"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sixth_semester);
		 ...
		 Spinner et1 = (Spinner)findViewById(R.id.spinner1);
	        ...
	        String fs1 = settingsfile.getString("sixs1","0");
	        String fs2 = settingsfile.getString("sixs2","0");
	        String fs3 = settingsfile.getString("sixs3","0");
	        String fs4 = settingsfile.getString("sixs4","0");
	        String fs5 = settingsfile.getString("sixs5","0");
	        String fs6 = settingsfile.getString("sixs6","0");
	        String fs7 = settingsfile.getString("sixs7","0");
	        String fs8 = settingsfile.getString("sixs8","0");
	        String fs9 = settingsfile.getString("sixs9","0");
...
public int Check(String a){
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sixth_semester, menu);
		return true;
	}
