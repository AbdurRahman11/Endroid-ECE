...
public class FirstSemester extends Activity {
...
public  void onSubClick(View View){
	...
	String a9 = et9.getSelectedItem().toString();
		...
		//Multiplying Grade Points
			...
			editor.putString("firstsum", String.valueOf(sum));
			editor.putString("firstmul", String.valueOf(mul));
			
			editor.putString("fs1", a1);
			editor.putString("fs2", a2);
			editor.putString("fs3", a3);
			editor.putString("fs4", a4);
			editor.putString("fs5", a5);
			editor.putString("fs6", a6);
			editor.putString("fs7", a7);
			editor.putString("fs8", a8);
			editor.putString("fs9", a9);
...
public int gradeCheck(String a){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fs1 = settingsfile.getString("fs1","0");
        String fs2 = settingsfile.getString("fs2","0");
        String fs3 = settingsfile.getString("fs3","0");
        String fs4 = settingsfile.getString("fs4","0");
        String fs5 = settingsfile.getString("fs5","0");
        String fs6 = settingsfile.getString("fs6","0");
        String fs7 = settingsfile.getString("fs7","0");
        String fs8 = settingsfile.getString("fs8","0");
        String fs9 = settingsfile.getString("fs9","0");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.first_semester, menu);
        return true;
    }
