...
public class FifthSemester extends Activity {
	...
	public void onSubClick(View View){
		...
		for(Integer key : nmap.keySet()){
			 ...
			 SharedPreferences settingsfile = PreferenceManager.getDefaultSharedPreferences(this);
				...
				editor.putString("fifthsum", String.valueOf(sum));
				editor.putString("fifthmul", String.valueOf(mul));
				
				editor.putString("fifs1", a1);
				editor.putString("fifs2", a2);
				editor.putString("fifs3", a3);
				editor.putString("fifs4", a4);
				editor.putString("fifs5", a5);
				editor.putString("fifs6", a6);
				editor.putString("fifs7", a7);
				editor.putString("fifs8", a8);
	...
	public int gradeCheck(String a){
		...
		/* else if(a.equals("NA")||a.equals("na")){
			...
			builder1.setMessage("Select a Subject");
		...
		setContentView(R.layout.activity_fifth_semester);
		 ...
		 Spinner et1 = (Spinner)findViewById(R.id.spinner1);
	    	...
	    	Spinner et8 = (Spinner)findViewById(R.id.spinner8);
	         ...
	         String fs1 = settingsfile.getString("fifs1","0");
	         String fs2 = settingsfile.getString("fifs2","0");
	         String fs3 = settingsfile.getString("fifs3","0");
	         String fs4 = settingsfile.getString("fifs4","0");
	         String fs5 = settingsfile.getString("fifs5","0");
	         String fs6 = settingsfile.getString("fifs6","0");
	         String fs7 = settingsfile.getString("fifs7","0");
	         String fs8 = settingsfile.getString("fifs8","0");
...
public int Check(String a){
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.fifth_semester, menu);
		return true;
	}
